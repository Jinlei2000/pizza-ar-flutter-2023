...
class _CustomizePizzaArPageState extends State<CustomizePizzaArPage> {
  ...
  //   Widget buildToppingsList(List<Map<String, dynamic>> toppings) {
  //     return SingleChildScrollView(
  //       padding: const EdgeInsets.only(left: 16),
  //       scrollDirection: Axis.horizontal,
  //       child: Row(
  ...
  //       // Vegetable
  //       if (_tabTextIndexSelected == 0) buildToppingsList(Pizza.vegetable),
  //       // Meat
  //       if (_tabTextIndexSelected == 1) buildToppingsList(Pizza.meat),
  //     ],
  //   );
  // }
